...
def main():
    ...
    while True:
        ...
        # Apply histogram equalization to enhance contrast (fixes dark camera issue)
        gray_frame = cv2.equalizeHist(gray_frame)
        
        # Also enhance the color frame for display
        # Split into channels, equalize each, then merge
